...
---@return self
function MouseInteractions:update(dt) end
...
---@return self
function MouseInteractions:mousepressed(x, y, button, istouch, presses) end
...
---@param presses number The number of presses in a short time frame and small area, used to simulate double, triple clicks.
---@return self
function MouseInteractions:mousereleased(x, y, button, istouch, presses)
end
...
---@param istouch boolean True if the mouse button press originated from a touchscreen touch-press.
---@return self
function MouseInteractions:mousemoved(x, y, dx, dy, istouch) end
...
---@return self
function MouseInteractions:wheelmoved(x, y) end